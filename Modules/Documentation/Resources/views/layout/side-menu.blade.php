...
@section('content')
    @include('documentation::layout.components.mobile-menu')
    <div class="flex">
        <!-- BEGIN: Side Menu -->
        <nav class="side-nav">
            <a href="" class="intro-x flex items-center pl-3 pt-4">
        ...
        <!-- BEGIN: Content -->
        <div class="content">
            <!-- This top bar comes from the main layout. Not from the docs module layout -->
