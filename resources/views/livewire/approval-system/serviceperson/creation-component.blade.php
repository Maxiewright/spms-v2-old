<div>
    ...
    @push('livewire-scripts')
        ...
        <script>
            livewireApprovalConfirmation('approveServiceperson', 'approveServicepersonCreation')
            livewireRejectionConfirmation('disapproveServiceperson', 'disapproveServicepersonCreation')
            reloadTab()
        </script>
    @endpush
</div>
