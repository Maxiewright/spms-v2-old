<div>
    <x-form.multi-step title="Medical" step="5" >
        <x-cards.form-card title="Bio Data" class="sm:col-span-4">
...
{{--            <livewire:serviceperson.create.medical.biodata.weight :data="$data" />--}}
        ...
        <x-cards.form-card title="Medical History" class="sm:col-span-8">
            <div class="p-3">
                <x-cards.form-card title="Vaccines"  class="mb-3">
                    <livewire:serviceperson.create.medical.history.vaccine :data="$data"/>
                </x-cards.form-card>
