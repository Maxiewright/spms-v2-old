    ...
    @if ($updateMode)
        <x-metadata.update title="{{$title}}">
            <x-slot name="updateFields">
                ...
                @include('livewire.manpower.career-management.partials.create_and_update_form_fields_with_type')
            </x-slot>
        </x-metadata.update>
    @else
        <x-metadata.create title="{{$title}}">
            <x-slot name="createFields">
                @include('livewire.manpower.career-management.create_and_update_form_fields_with_type')
            </x-slot>
        </x-metadata.create>
    @endif
