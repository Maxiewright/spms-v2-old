...
class ServicepersonSportPolicy
{
     ...
     *
     * @param User $user
     * @param ServicepersonSport $details
     * @return mixed
     */
    public function view(User $user, ServicepersonSport $details)
    {
     ...
     * @return mixed
     */
    public function update(User $user, ServicepersonSport $details)
    {
     ...
     * @return mixed
     */
    public function delete(User $user, ServicepersonSport $details)
    {
     ...
     * @return mixed
     */
    public function restore(User $user, ServicepersonSport $details)
    {
     ...
     * @return mixed
     */
    public function forceDelete(User $user, ServicepersonSport $details)
    {
