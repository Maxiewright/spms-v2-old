...
class DriversPermitPolicy
{
     ...
     * @return mixed
     */
    public function view(User $user, DriversPermit $driversPermit)
    {
        ...
        return $user->hasModel('driversPermit', $driversPermit);
    }
     ...
     * @return mixed
     */
    public function update(User $user, DriversPermit $driversPermit)
    {
        ...
        return $user->hasModel('driversPermits', $driversPermit);
    }
     ...
     * @return mixed
     */
    public function delete(User $user, DriversPermit $driversPermit)
    {
     ...
     * @return mixed
     */
    public function restore(User $user, DriversPermit $driversPermit)
    {
     ...
     * @return mixed
     */
    public function forceDelete(User $user, DriversPermit $driversPermit)
    {
