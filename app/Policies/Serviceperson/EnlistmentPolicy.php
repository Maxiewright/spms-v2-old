...
class EnlistmentPolicy
{
     ...
     * @return mixed
     */
    public function view(User $user, Enlistment $enlistment)
    {
        ...
        $user->hasModel('enlistments', $enlistment);
    }
     ...
     * @return mixed
     */
    public function update(User $user, Enlistment $enlistment)
    {
     ...
     * @return mixed
     */
    public function delete(User $user, Enlistment $enlistment)
    {
     ...
     * @return mixed
     */
    public function restore(User $user, Enlistment $enlistment)
    {
     ...
     * @return mixed
     */
    public function forceDelete(User $user, Enlistment $enlistment)
    {
