...
class ServicepersonAllergyPolicy
{
     ...
     *
     * @param User $user
     * @param ServicepersonAllergy $details
     * @return mixed
     */
    public function view(User $user, ServicepersonAllergy $details)
    {
     ...
     * @return mixed
     */
    public function update(User $user, ServicepersonAllergy $details)
    {
     ...
     * @return mixed
     */
    public function delete(User $user, ServicepersonAllergy $details)
    {
     ...
     * @return mixed
     */
    public function restore(User $user, ServicepersonAllergy $details)
    {
     ...
     * @return mixed
     */
    public function forceDelete(User $user, ServicepersonAllergy $details)
    {
