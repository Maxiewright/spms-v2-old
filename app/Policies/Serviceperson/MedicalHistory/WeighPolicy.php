...
class WeighPolicy
{
     ...
     * @return mixed
     */
    public function view(User $user, Weigh $weigh)
    {
     ...
     * @return mixed
     */
    public function update(User $user, Weigh $weigh)
    {
     ...
     * @return mixed
     */
    public function delete(User $user, Weigh $weigh)
    {
     ...
     * @return mixed
     */
    public function restore(User $user, Weigh $weigh)
    {
     ...
     * @return mixed
     */
    public function forceDelete(User $user, Weigh $weigh)
    {
