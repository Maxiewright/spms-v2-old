...
class ServicepersonMedicalConditionPolicy
{
     ...
     *
     * @param User $user
     * @param ServicepersonMedicalCondition $details
     * @return mixed
     */
    public function view(User $user, ServicepersonMedicalCondition $details)
    {
     ...
     * @return mixed
     */
    public function update(User $user, ServicepersonMedicalCondition $details)
    {
     ...
     * @return mixed
     */
    public function delete(User $user, ServicepersonMedicalCondition $details)
    {
     ...
     * @return mixed
     */
    public function restore(User $user, ServicepersonMedicalCondition $details)
    {
     ...
     * @return mixed
     */
    public function forceDelete(User $user, ServicepersonMedicalCondition $details)
    {
